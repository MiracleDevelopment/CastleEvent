...
class RecordListEvent(context: Context) {
    ...
    fun pushEventRealTime(eventId: String, eventName: String, logoEvent: String, count: Long, dateStamp: String, timeStamp: Long): Task<Void>? {
        mRecorderTickets = RecorderTickets(eventId, eventName, logoEvent, count, dateStamp, timeStamp)
